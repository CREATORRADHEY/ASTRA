...
export default async function SignupPage(props: {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-mono selection:bg-indigo-500/30 p-6 relative overflow-hidden" style={{
      ...
      <div className="absolute top-[15%] right-[10%] text-[8vw] font-bold text-white/[0.02] select-none pointer-events-none uppercase tracking-tighter rotate-[15deg]">
        blind spot
      </div>
      <div className="absolute bottom-[15%] left-[10%] text-[8vw] font-bold text-white/[0.02] select-none pointer-events-none uppercase tracking-tighter rotate-[-15deg]">
        calibration
      </div>
      ...
      <div className="w-full max-w-md bg-[#111]/80 backdrop-blur-xl border border-white/10 rounded-xl p-8 shadow-2xl space-y-8 relative z-10" style={{
        ...
        <div className="text-center">
          <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-[0.3em] mb-2">Step 1 of 1</p>
        ...
        <form className="flex flex-col gap-4">
          {/* FIX 10: Visual Hierarchy - Essentials First */}
          ...
          <div className="flex flex-col gap-6 pt-2">
            ...
            <div className="space-y-3">
              <button
                formAction={signup}
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-md font-bold transition-all shadow-lg shadow-indigo-900/20 active:scale-[0.98]"
              >
                Sign Up & Begin Calibration
              </button>
              <p className="text-[10px] text-gray-600 text-center uppercase tracking-widest">Takes less than 30 seconds.</p>
            </div>
            
            <div className="text-center space-y-4">
              <div className="space-y-1">
                <p className="text-xs text-gray-400 font-medium">Start building your Calibration Score today.</p>
                <p className="text-[10px] text-gray-600">We don&apos;t share your data. Your decisions stay private.</p>
              </div>
        ...
        {/* FIX 2: Hook Line - Moved Below Form */}
        ...
        {/* FIX 7: Footer Hook */}
        <p className="text-center text-[10px] text-gray-600 uppercase tracking-[0.2em] pt-4 border-t border-white/5 opacity-50">
